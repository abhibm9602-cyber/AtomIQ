...
- Atomic Positions (fractional):"""
    ...
    def generate_dft_or_code_script(self, target_type: str, parameters: str) -> Dict[str, Any]:
        ...
        - Provide ONLY code with clear explanatory comments. Do not wrap the output in markdown code blocks, just raw text.
        """
        ...
        try:
            ...
            prompt_critic = f"""
            You are a Senior Computational Physics Reviewer. Your job is to review a script generated by a junior physicist and fix any physical inconsistencies, parameter mismatches, or syntactic errors.
            ...
            TASK:
            1. First, provide a brief 'Critique' (max 3-4 sentences) pointing out any missing parameters, physical flaws (e.g., bad k-point grid, wrong algorithm choice), or syntactic errors in the draft. If the draft is perfect, state why it is physically sound.
            2. Then, provide the 'Refined Code' which fixes these issues.
            ...
            if "REFINED CODE:" in critic_text:
                ...
                critique = "Critic failed to follow format. Proceeding with initial draft."
